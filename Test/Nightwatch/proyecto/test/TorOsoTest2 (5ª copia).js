...
//Demo test
  ...
  'Demo test TorOso Inversor BOT DOSSSSSSSSSSSS-2' : function (browser) {
  ...
  'Demo test TorOso Inversor BOT DOSSSSSSSSSSSS-cazar-2' : function (browser) {
        cazarTorOso();
...
browser
  ...
  'Demo test TorOso Inversor BOT TREESSSSS 1222-3' : function (browser) {
  ...
  'Demo test TorOso Inversor BOT TREESSSSS 122222222-cazar-3' : function (browser) {
        //cazarTorOso();
   ...
   'Demo test TorOso Inversor BOT TREESSSSS 122222222-cazar 2-3' : function (browser) {
    browser                
                            .pause(10000);
  },
