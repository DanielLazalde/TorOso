...
//      //.waitForElementPresent("//div[contains(@class, 'instrument green-change win-disposable selected')/div/span[text()='Oil']]")
...
//SELECCIONAR REGISTRO DEL GRID

//.waitForElementPresent("//div[contains(@class, 'instrument green-change win-disposable')/div/span[text()='Gold']]")

//.click('//div[contains(@class, "instrument green-change win-disposable")/div/span[text()="Gold"]]')
.useXpath()
//.waitForElementVisible("//div[contains(@class, 'section-table instruments')", 1000)
.waitForElementVisible('//div[contains(@class,"instrument green-change win-disposable")][1]', 1000)
       .pause(5000)
...
.click('//div[contains(@class,"instrument green-change win-disposable")][1]')

.click('//div[contains(@class,"instrument green-change win-disposable")][1]/div/button[@class="buySellButton"]')
